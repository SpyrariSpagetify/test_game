...
import col from './entities/my_coin';
import vrag from './entities/test_ememy.js';
...
export default function onload() {
    ...
    me.loader.preload(resources, () => {
        ...
        me.pool.register("col", col);
        me.pool.register("vrag", vrag);
        ...
        stuff.sprt3 = new me.TextureAtlas(
            me.loader.getJSON("sprt3"),
            me.loader.getImage("sprt3")
        );
